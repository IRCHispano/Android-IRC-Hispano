 ...
 */
package org.irchispano.command;

import java.util.HashMap;

import org.irchispano.command.handler.AMsgHandler;
import org.irchispano.command.handler.AwayHandler;
import org.irchispano.command.handler.CloseHandler;
import org.irchispano.command.handler.DCCHandler;
import org.irchispano.command.handler.DeopHandler;
import org.irchispano.command.handler.DevoiceHandler;
import org.irchispano.command.handler.EchoHandler;
import org.irchispano.command.handler.HelpHandler;
import org.irchispano.command.handler.JoinHandler;
import org.irchispano.command.handler.KickHandler;
import org.irchispano.command.handler.MeHandler;
import org.irchispano.command.handler.ModeHandler;
import org.irchispano.command.handler.MsgHandler;
import org.irchispano.command.handler.NamesHandler;
import org.irchispano.command.handler.NickHandler;
import org.irchispano.command.handler.NoticeHandler;
import org.irchispano.command.handler.OpHandler;
import org.irchispano.command.handler.PartHandler;
import org.irchispano.command.handler.QueryHandler;
import org.irchispano.command.handler.QuitHandler;
import org.irchispano.command.handler.RawHandler;
import org.irchispano.command.handler.TopicHandler;
import org.irchispano.command.handler.VoiceHandler;
import org.irchispano.command.handler.WhoisHandler;
